...
import { V3, dirFromYawPitch, dist2d, yawTo, deg, rand, angDiff, clamp, gauss } from './utils.js?v=30';
import { AGENTS } from './config.js?v=30';
import { spawnSmoke, spawnZone, spawnWall, targetRing, teleportFX, flashFX, spawnTurret, spawnTrap, spawnDevice, suppressFX, explosionFX, tracer, removeMesh, attachProjectileVisual, updateProjectileVisual, removeProjectileVisual } from './effects.js?v=30';
import { eyePos, rayWalls, traceRay, makeWeapon, applyDamage, hitSpheres, losBlocked } from './combat.js?v=30';
import { inAnyOpen, colQuery } from './map.js?v=30';
    ...
    case 'hunterUlt': {
      ...
      for(let i=0;i<3;i++){
        schedule(i*.6, ()=>{
          ...
          import('./effects.js?v=30').then(fx=> fx.tracer(o, eyePos(t), 0x80c0ff));
          sfx.shot('ult', G.player? o.distanceTo(G.player.pos):0);
